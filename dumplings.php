...
include('includes/header.php'); ?>    
    <main>
      <article>
        ...
        <section>
          <h3>Description</h3>
          <p>Instant Pot Chicken and Dumplings is full of tender chicken and vegetables with easy homemade dumplings. One of the best Instant Pot dinner recipes!</p>
        </section>
        <section>
          <h3>Ingredients</h3>
            <ul>
              <li><sup>1</sup>/<sub>2</sub> tablespoon olive oil</li>
              <li>1 cup diced onion</li>
              <li><sup>1</sup>/<sub>2</sub> cup diced carrot</li>
              ...
              <li><sup>1</sup>/<sub>2</sub> teaspoon thyme(optional)</li>
              <li><sup>1</sup>/<sub>2</sub> teaspoon dried marjoram</li>
              <li>1 teaspoon salt (optional)</li>
              <li><sup>1</sup>/<sub>4</sub> teaspoon freshly ground black pepper</li>
              <li>2 tablespoons unsalted butter, softened</li>
              <li>2 tablespoons all-purpose flour</li>
              <li>salt and ground black pepper to taste (optional)</li>
              <li><sup>1</sup>/<sub>2</sub> cup frozen petite peas</li>
              <li><sup>1</sup>/<sub>2</sub> cup frozen cut green beans</li>
            </ul>
            <section>
              <h4>Dumplings:</h4>
              <ul>
